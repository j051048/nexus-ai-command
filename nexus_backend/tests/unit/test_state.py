...
class TestAgentConfig:
    def test_defaults(self):
        ...
        assert config.mini_model == "deepseek-v4.1-flash"
    ...
    def test_get_model_for_complexity(self):
        ...
        assert config.get_model_for_complexity(QueryComplexity.SIMPLE) == "deepseek-v4.1-flash"
        assert config.get_model_for_complexity(QueryComplexity.MODERATE) == "deepseek-v4.1-flash"
