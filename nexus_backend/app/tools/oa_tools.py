...
class LeaveRequestTool(BaseTool):
    ...
    parameters = {
        ...
        "properties": {
            "leave_type": {
                "type": "string",
                "enum": ["annual", "sick", "personal", "compensatory", "maternity", "paternity"],
...
class LeaveQueryTool(BaseTool):
    ...
    async def run(self, args: Dict[str, Any], user_id: str, config: Dict[str, Any] = None) -> str:
        ...
        if query_type == "my_requests":
            ...
            type_names = {"annual": "年假", "sick": "病假", "personal": "事假", "compensatory": "调休"}
...
class MeetingBookingTool(BaseTool):
    ...
    async def run(self, args: Dict[str, Any], user_id: str, config: Dict[str, Any] = None) -> str:
        ...
        # 模拟会议室查找
        room_name = {"small": "洽谈室A", "medium": "会议室301", "large": "多功能厅"}.get(room_pref, "会议室301")
