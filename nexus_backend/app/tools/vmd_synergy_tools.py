...
class MonitorIndustryTrendsTool(BaseTool):
    ...
    examples = [
        {
            "input": {"category": "policy", "industry": "环保监测"},
            "output_summary": "生成环保监测领域最新政策法规动态报告",
        },
        {
            "input": {"category": "technology", "keywords": "拉曼光谱,AI检测"},
            "output_summary": "生成拉曼光谱和AI检测相关的技术趋势报告",
        },
...
class GenerateMarketResearchTool(BaseTool):
    ...
    examples = [
        {
            "input": {"market_segment": "环保监测仪器市场", "region": "华东"},
...
class GenerateCompetitorAnalysisTool(BaseTool):
    ...
    examples = [
        ...
        {
            "input": {"competitor_name": "赛默飞", "analysis_depth": "quick"},
...
class AggregateCustomerFeedbackTool(BaseTool):
    ...
    examples = [
        ...
        {
            "input": {"time_range": "last_year", "feedback_type": "all"},
