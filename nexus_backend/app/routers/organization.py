...
Provides endpoints for managing organizational hierarchy.
"""
...
@router.get("/users/{target_user_id}/reporting-line")
...
@router.get("/users/{manager_id}/direct-reports")
...
@router.get("/users/{manager_id}/team")
async def get_team_hierarchy(
    ...
    return {
        "success": True,
        "data": team.to_dict() if team else None
    }
...
@router.get("/approval-chains/{approval_type}/level")
...
@router.post("/approval-chains/process")
