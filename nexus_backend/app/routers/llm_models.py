...
# ---------------------------------------------------------------------------
# Model marketplace / available models
# ---------------------------------------------------------------------------
...
MODEL_CATALOG: dict[str, dict] = {
    # ─── OpenAI GPT ───
    "gpt-4o": {"name": "GPT-4o", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 16384, "tools": True, "streaming": True, "input_price": 2.5, "output_price": 10.0, "tags": ["推荐", "多模态"]},
    "gpt-4o-2024-11-20": {"name": "GPT-4o (Nov 2024)", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 16384, "tools": True, "streaming": True, "input_price": 2.5, "output_price": 10.0, "tags": ["多模态"]},
    "gpt-4o-mini": {"name": "GPT-4o Mini", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 16384, "tools": True, "streaming": True, "input_price": 0.15, "output_price": 0.6, "tags": ["推荐", "高性价比"]},
    "gpt-4-turbo": {"name": "GPT-4 Turbo", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 10.0, "output_price": 30.0, "tags": []},
    "gpt-4-turbo-preview": {"name": "GPT-4 Turbo Preview", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 10.0, "output_price": 30.0, "tags": []},
    "gpt-4": {"name": "GPT-4", "provider": "openai", "type": "chat", "context": 8192, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 30.0, "output_price": 60.0, "tags": []},
    "gpt-3.5-turbo": {"name": "GPT-3.5 Turbo", "provider": "openai", "type": "chat", "context": 16385, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.5, "output_price": 1.5, "tags": ["经济"]},
    "o1": {"name": "o1", "provider": "openai", "type": "chat", "context": 200000, "max_tokens": 100000, "tools": False, "streaming": True, "input_price": 15.0, "output_price": 60.0, "tags": ["深度推理"]},
    "o1-mini": {"name": "o1 Mini", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 65536, "tools": False, "streaming": True, "input_price": 3.0, "output_price": 12.0, "tags": ["推理"]},
    "o1-preview": {"name": "o1 Preview", "provider": "openai", "type": "chat", "context": 128000, "max_tokens": 32768, "tools": False, "streaming": True, "input_price": 15.0, "output_price": 60.0, "tags": ["推理"]},
    "o3-mini": {"name": "o3 Mini", "provider": "openai", "type": "chat", "context": 200000, "max_tokens": 100000, "tools": True, "streaming": True, "input_price": 1.1, "output_price": 4.4, "tags": ["推荐", "推理", "高性价比"]},
    # ─── Claude ───
    "claude-3-5-sonnet-20241022": {"name": "Claude 3.5 Sonnet", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 3.0, "output_price": 15.0, "tags": ["推荐", "长上下文"]},
    "claude-3-5-sonnet-latest": {"name": "Claude 3.5 Sonnet (Latest)", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 3.0, "output_price": 15.0, "tags": ["推荐"]},
    "claude-3-5-haiku-20241022": {"name": "Claude 3.5 Haiku", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 1.0, "output_price": 5.0, "tags": ["高性价比"]},
    "claude-3-opus-20240229": {"name": "Claude 3 Opus", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 15.0, "output_price": 75.0, "tags": ["最强推理"]},
    "claude-3-sonnet-20240229": {"name": "Claude 3 Sonnet", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 3.0, "output_price": 15.0, "tags": []},
    "claude-3-haiku-20240307": {"name": "Claude 3 Haiku", "provider": "anthropic", "type": "chat", "context": 200000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.25, "output_price": 1.25, "tags": ["经济"]},
    # ─── Google Gemini ───
    "gemini-2.0-flash": {"name": "Gemini 2.0 Flash", "provider": "google", "type": "chat", "context": 1048576, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.1, "output_price": 0.4, "tags": ["推荐", "超长上下文", "高性价比"]},
    "gemini-2.0-flash-exp": {"name": "Gemini 2.0 Flash Exp", "provider": "google", "type": "chat", "context": 1048576, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.1, "output_price": 0.4, "tags": ["实验"]},
    "gemini-1.5-pro": {"name": "Gemini 1.5 Pro", "provider": "google", "type": "chat", "context": 2097152, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 1.25, "output_price": 5.0, "tags": ["超长上下文"]},
    "gemini-1.5-flash": {"name": "Gemini 1.5 Flash", "provider": "google", "type": "chat", "context": 1048576, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.075, "output_price": 0.3, "tags": ["高性价比"]},
    "gemini-2.5-pro-exp-03-25": {"name": "Gemini 2.5 Pro", "provider": "google", "type": "chat", "context": 1048576, "max_tokens": 65536, "tools": True, "streaming": True, "input_price": 1.25, "output_price": 10.0, "tags": ["推荐", "最新"]},
    # ─── DeepSeek ───
    "deepseek-chat": {"name": "DeepSeek V3", "provider": "deepseek", "type": "chat", "context": 64000, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.27, "output_price": 1.1, "tags": ["推荐", "国产", "高性价比"]},
    "deepseek-reasoner": {"name": "DeepSeek R1", "provider": "deepseek", "type": "chat", "context": 64000, "max_tokens": 8192, "tools": False, "streaming": True, "input_price": 0.55, "output_price": 2.19, "tags": ["推荐", "深度推理", "国产"]},
    # ─── Qwen (通义千问) ───
    "qwen-max": {"name": "通义千问 Max", "provider": "qwen", "type": "chat", "context": 32000, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 2.0, "output_price": 6.0, "tags": ["国产"]},
    "qwen-plus": {"name": "通义千问 Plus", "provider": "qwen", "type": "chat", "context": 131072, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.5, "output_price": 1.5, "tags": ["国产", "高性价比"]},
    "qwen-turbo": {"name": "通义千问 Turbo", "provider": "qwen", "type": "chat", "context": 131072, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.2, "output_price": 0.6, "tags": ["国产", "经济"]},
    "qwen2.5-72b-instruct": {"name": "Qwen 2.5 72B", "provider": "qwen", "type": "chat", "context": 131072, "max_tokens": 8192, "tools": True, "streaming": True, "input_price": 0.8, "output_price": 2.0, "tags": ["国产", "开源"]},
    # ─── GLM (智谱) ───
    "glm-4-plus": {"name": "GLM-4 Plus", "provider": "zhipu", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 1.5, "output_price": 5.0, "tags": ["国产"]},
    "glm-4-flash": {"name": "GLM-4 Flash", "provider": "zhipu", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.0, "output_price": 0.0, "tags": ["国产", "免费"]},
    # ─── Moonshot (月之暗面) ───
    "moonshot-v1-128k": {"name": "Moonshot v1 128K", "provider": "moonshot", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 1.0, "output_price": 3.0, "tags": ["国产", "长上下文"]},
    "moonshot-v1-32k": {"name": "Moonshot v1 32K", "provider": "moonshot", "type": "chat", "context": 32000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.5, "output_price": 1.5, "tags": ["国产"]},
    # ─── Mistral ───
    "mistral-large-latest": {"name": "Mistral Large", "provider": "mistral", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 3.0, "output_price": 9.0, "tags": []},
    "mistral-small-latest": {"name": "Mistral Small", "provider": "mistral", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.1, "output_price": 0.3, "tags": ["经济"]},
    # ─── Meta Llama ───
    "llama-3.1-405b": {"name": "Llama 3.1 405B", "provider": "meta", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 3.0, "output_price": 3.0, "tags": ["开源"]},
    "llama-3.1-70b": {"name": "Llama 3.1 70B", "provider": "meta", "type": "chat", "context": 128000, "max_tokens": 4096, "tools": True, "streaming": True, "input_price": 0.6, "output_price": 0.6, "tags": ["开源", "高性价比"]},
    # ─── Embedding 模型 ───
    "text-embedding-3-large": {"name": "Text Embedding 3 Large", "provider": "openai", "type": "embedding", "context": 8191, "max_tokens": 0, "tools": False, "streaming": False, "input_price": 0.13, "output_price": 0, "tags": ["推荐", "向量"]},
    "text-embedding-3-small": {"name": "Text Embedding 3 Small", "provider": "openai", "type": "embedding", "context": 8191, "max_tokens": 0, "tools": False, "streaming": False, "input_price": 0.02, "output_price": 0, "tags": ["向量", "经济"]},
    "text-embedding-ada-002": {"name": "Ada v2 Embedding", "provider": "openai", "type": "embedding", "context": 8191, "max_tokens": 0, "tools": False, "streaming": False, "input_price": 0.1, "output_price": 0, "tags": ["向量"]},
}
