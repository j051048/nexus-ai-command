...
class ErrorCode(StrEnum):
    ...
    # Convenience aliases (used across 30+ router files)
    FORBIDDEN = "AUTH_PERMISSION_DENIED"
    AUTH_FORBIDDEN = "AUTH_PERMISSION_DENIED"
    NOT_FOUND = "RESOURCE_NOT_FOUND"
    VALIDATION_ERROR = "VALIDATION_INVALID_INPUT"
