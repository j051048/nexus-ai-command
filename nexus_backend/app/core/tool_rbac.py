...
TOOL_PERMISSIONS = {
    "sales_rep": {
        "allowed": [
            "get_customer", "search_customers", "create_lead",
            "update_lead", "get_sales_lead", "list_sales_leads"
        ],
        "denied": ["delete_customer", "approve_payment", "delete_contract"]
    },
    "finance": {
        "allowed": [
            "get_invoice", "create_payment", "get_contract",
            "list_invoices", "get_payment_status"
        ],
        "denied": ["delete_invoice", "delete_payment"]
    },
    "manager": {
        "allowed": [
            "approve_expense", "approve_leave", "get_team_performance",
            "create_approval", "update_approval"
        ],
