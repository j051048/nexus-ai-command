...
_DEMO_PROJECTS = [
    {
        "name": "Q1 大客户拓展计划",
        "description": "针对年营收过亿的潜在客户进行定向拓展",
        "status": "in_progress",
        "progress": 65,
    },
    {
        "name": "CRM 系统升级项目",
        "description": "升级客户管理系统，集成 AI 辅助分析功能",
        "status": "in_progress",
        "progress": 40,
    },
    {
        "name": "新产品发布会筹备",
        "description": "2025 春季新品线上发布会策划与执行",
        "status": "planning",
        "progress": 15,
    },
    {
        "name": "客户满意度调研",
        "description": "针对核心客户进行 NPS 调研与分析",
        "status": "completed",
        "progress": 100,
    },
]
