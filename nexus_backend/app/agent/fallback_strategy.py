...
# 降级链配置
FALLBACK_CHAINS = {
    "send_email": ["send_email_smtp", "send_email_sendgrid", "send_sms", "create_notification"],
    "get_customer_crm": ["get_customer_cache", "get_customer_basic"],
    "search_documents": ["search_documents_vector", "search_documents_fulltext", "search_documents_basic"],
}
