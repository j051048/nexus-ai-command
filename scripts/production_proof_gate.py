...
CHECKS = [
    ...
    ProofCheck(
        "scientific artifact evidence and quality pipeline",
        "nexus_backend/app/services/artifact_quality_service.py",
        (
    ...
    ProofCheck(
        "scientific artifact quality matrix",
        "nexus_backend/evals/datasets/scientific_artifact_quality_matrix.json",
        (
    ...
    ProofCheck(
        "artifact quality observability API",
        "nexus_backend/app/routers/agent_observability.py",
        (
            '"/quality/artifacts"',
            "agent_artifact_quality_events",
            "ready_rate",
            "avg_repair_count",
            "top_failure_codes",
        ),
    ...
    ProofCheck(
        "artifact quality persistence and feedback governance",
        "supabase/migrations/20260721_002_agent_artifact_quality_pipeline.sql",
        (
            "agent_artifact_quality_events",
            "ENABLE ROW LEVEL SECURITY",
            "quality_snapshot",
            "review_candidate",
            "idx_solution_feedback_learning_queue",
        ),
    ),
    ProofCheck(
